...
def get_similarity(word):
    ...
    similarity=cosine_distances(reshaped_word_embedding,reshaped_centroid)[0][0] #somiglianza tra centroide e vettore di parole calcolata come il coseno dell'angolo tra i tensori
    return similarity